"""HTTP client for Autodesk Construction Cloud (C30. Email Marketing & Newsletter)."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://api.autodesk_construction_cloud.com"

class AutodeskConstructionCloudClient:
    def __init__(self, api_key: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-autodesk_construction_cloud/0.1.0"
        }
