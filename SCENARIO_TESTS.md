# PST Testing Scenarios for Autodesk Construction Cloud Connector

## Part A: Authentication & Connectivity Verification
- **Scenario A1: Valid Credential Connect**: `connect_autodesk_construction_cloud_connector` saves token and validates endpoint.
...
- **Scenario C1: Connection Lifecycle**: Clean disconnect via `disconnect_autodesk_construction_cloud_connector` without lingering secrets.
