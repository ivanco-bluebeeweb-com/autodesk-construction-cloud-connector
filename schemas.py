"""Pydantic schemas for Autodesk Construction Cloud Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Autodesk Construction Cloud.")
    api_token: str = Field(description="Platform Access Token / API Key")
    base_url: str = Field(default="https://developer.api.autodesk.com/construction/v1", description="Autodesk Construction Cloud API base URL.")
...
class GetProjectRecordParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    projectrecord_id: str = Field(description="Autodesk Construction Cloud ProjectRecord ID.")
