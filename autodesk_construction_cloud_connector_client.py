"""HTTP client for Autodesk Construction Cloud API."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://developer.api.autodesk.com/construction/v1"
...
class AutodeskConstructionCloudClient:
    def __init__(self, api_token: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-AutodeskConstructionCloud-Connector/1.0.0"
        }
