"""Settings panel for Autodesk Construction Cloud Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__autodesk_construction_cloud_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=autodesk_construction_cloud_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_autodesk_construction_cloud"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Autodesk Construction Cloud Settings & Accounts", level=2),
